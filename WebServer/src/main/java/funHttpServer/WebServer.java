      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          // a response that makes sense
            ...
            e.printStackTrace();
            response = ("<html>ERROR: 400 - Invalid Input</html>").getBytes();
          ...
          String ownerID = obj.getString("id");
          String ownerName = obj.getObj("owner").getString("login");
          
          resp = name + " " + ownerID + " " + ownerName;
